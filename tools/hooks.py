...
def generate_datetime(expr=''):
	...
	:param expr: 日期表达式，如"d-1"代表日期减1;年y,月m,日d,时h,分M,秒s
	:return:
	"""
...
if __name__ == "__main__":
	...
	#ip转整数
	print(iptoint('192.168.5.120'))

	#计算函数
	print(sum_data(29,39))

	#token设置
	print(set_token('DPn3ZB1AcUi6az/GMSrY1Zi36cHV+i+IyF85lqNE/UI='))